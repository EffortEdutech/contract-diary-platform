// frontend/src/components/boq/EditBOQItemModal.js - ENHANCED WITH SECTION SUPPORT
import React, { useState, useEffect } from 'react';
import { updateBOQItem, validateBOQItem } from '../../services/boqService';

function EditBOQItemModal({ isOpen, onClose, item, sections = [], onItemUpdated }) {
  ...
  useEffect(() => {
    if (item) {
      setFormData({
        ...
        section_id: item.section_id || '', // NEW: Pre-fill section
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-lg">
          <h3 className="text-lg font-semibold text-gray-900">Edit BOQ Item</h3>
