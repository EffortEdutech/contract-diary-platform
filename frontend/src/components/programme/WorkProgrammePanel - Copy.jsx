...
export default function WorkProgrammePanel({
  ...
  const [weightMode, setWeightMode] = useState('boq'); // 'boq' or 'duration'
    ...
    {loading ? (
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white border rounded-lg overflow-hidden">
          ...
          {showVersionsPanel && (
            <div className="p-4">
              {/* ✅ YOUR EXISTING “Programme Versions” CARD START */}
              <div className="bg-white border rounded-lg overflow-hidden">
              ...
              {/* ✅ YOUR EXISTING “Programme Versions” CARD END */}
            </div>
          )}
        </div>
          ...
          {showWbsPanel && (
            <div className="p-4">
              ...
              <div className="overflow-x-auto">
                {/* ✅ YOUR EXISTING “Activities (WBS)” CARD START */}
                <div className="bg-white border rounded-lg overflow-hidden">
                  {/* Header */}
                      ...
                      <div className="mt-3 flex flex-col gap-2">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          >
                            ...
                            <option value="duration">Roll-up Weight: Duration</option>
                          </select>
                        </div>
                ...
                {/* ✅ YOUR EXISTING “Activities (WBS)” CARD END */}
              </div>
            </div>
          )}
        </div>
