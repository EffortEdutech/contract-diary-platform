# WorkLedger Architecture Guideline

## BOQ – Programme – Site Activity Integration

> **System-aligned guideline based on existing WorkLedger database schema**
...
Which means WorkLedger is structurally a:
